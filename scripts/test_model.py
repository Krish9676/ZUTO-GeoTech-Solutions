...
def main():
    ...
    # Get model metadata
    model_metadata = get_model_metadata(session)
    print(f"Model loaded successfully!")
    print(f"Input name: {model_metadata['input_name']}")
    print(f"Input shape: {model_metadata['input_shape']}")
    print(f"Output name: {model_metadata['output_name']}")
    print(f"Output shape: {model_metadata['output_shape']}")
